...
The smoke must report the tagged version, current MCP protocol, the documented tool count, zero initial memories, zero cross-scope memories, and zero cross-installation memories across two independent homes.
